...
if(mysqli_connect_errno($conexao)){
    ...
    elseif (isset($_POST['cadastrar1'])){
        $sql = "INSERT INTO db_usuarios (nomeUsu,loginUsu,senhaUsu)VALUES('$_POST[nome]','$_POST[login]','$_POST[senha]')";
		...
		echo "Usuário inserido com sucesso!!!";
            ...
            echo "Erro ao inserir Usuario! Erro: ".mysqli_error($conexao);
        }
    }
